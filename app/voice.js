// Desktop app voice backend (main process).
...
// tasks) never open overlapping Edge WebSocket connections — that churn is what
// makes Microsoft drop the stream mid-utterance ("no turn.end received").
